...
def run_single_task(task, output_dir, model_name=None, num_steps=30, iterations_per_step=50, device=None):
...
def worker_function(task_queue, result_dict, gpu_id, model_name, output_base_dir, num_steps, iterations_per_step):
    """
    병렬 처리를 위한 작업자 함수
